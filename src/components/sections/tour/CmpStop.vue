  ...
  methods: {
    checkStop() {
      ...
      if(this.stop.action === 'check') {
        this.$fire({
          title: "Congrats! You checked " + this.stop.name,
          type: "success",
          html:`You discovered the following letter of your <i>promocode</i>: <strong>${this.stop.promo}</strong><br/><br/>Use the this Gmaps link to reach the next location of your journey <br/> <a target="_blank" href="${this.stop.path}">Reach next location</a>`,
        })
      }
      ...
      if(this.stop.action === 'promo') {
        this.$fire({
          title: "Congrats! You checked " + this.stop.name, 
          type: "success",   
          html:`Now you can use the <i>promocode</i> to get a 10% discount in this store. Hope you appreciate this!!<br/><br/>
          ...
          <br/><br/>Use the this Gmaps link to reach the next location of your journey <br/> <a target="_blank" href="${this.stop.path}">Reach next location</a>`   
        })
      }    
    }
  },
